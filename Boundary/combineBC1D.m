...
RHS(G(i-1)) = RHS(G(i-1))-M(rightE).*BC.right.c./(BC.right.b/2 + BC.right.a/dx(end));
...
RHS(G(i+1)) = RHS(G(i+1))-M(leftW).*BC.left.c./(BC.left.b/2 - BC.left.a/dx(1));
